...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
    ...
    <?php
            ...
            $result = mysqli_query($con, 'SELECT consultas.CodConsulta , consultas.CodCliente , clientes.Nome FROM consultas INNER JOIN clientes ON consultas.CodCliente = clientes.CodCliente');
  ...
  <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="src/images/backgrounds/02.jpg">
    ...
    <div class="main-menu-content">
      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item has-sub"><a href="reports.php"><i class="ft-file-text"></i><span class="menu-title" data-i18n="">Reports</span></a>
          <ul class="menu-content">
            <li class=" nav-item"><a href="agendaEM.php">Agenda Exames</a></li>
            <li class=" nav-item"><a href="listaTA.php">Lista Trabalhadores</a></li>
            <li ><a class="menu-item" href="convocatoria.php">Convocat&oacute;ria</a></li>
          </ul>
        </li>
        <li class="active"><a href="teste.php"><i class="ft-package"></i><span class="menu-title" data-i18n="">Desenvolvedor</span></a>
        </li>
...
<!-- TABELA CONSULTAS + BOOTSTRAP ---------------------------------------------------------------------------------------->
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
          <h3 class="content-header-title">P&aacutegina de Testes</h3>
        </div>
          ...
          <div class="breadcrumbs-top float-md-right">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">titulo.Tabela
                </li>
              </ol>
            </div>
          </div>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Listagem de titulo.Tabela</h4>
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <h5>Bugs:</h5><br>
          &emsp; - Fix na função update, tentar retirar página update.php e usar modal. <br>
          &emsp; - Botão 'limpar' ( JS/JQuery) apaga o conteúdo dos campos de todos os formulários. (FIXED) <br>
          &emsp; - Position fix do datepicker. (FIXED) <br>
          &emsp; - Atualizar ADD + DELETE + UPDATE statements de códigos para nomes (Erros de Constraint). <br>
          &emsp; - Erro ao apagar empresa devido a constraint, arranjar maneira de relacionar tabela empresas com tabela consultas. (FEITO) <br>
          &emsp; - Erro ao adicionar consulta devido a constraint com a tabela clínicas. (Erro de base de dados?) <br>
          &emsp; - Erro ao adicionar cliente devido a constraint com a tabela empresas. (Erro de base de dados?) <br>
          &emsp; - Fix no sort by da tabela empresas.
          <br><br><br>
          <h5>Notas:</h5><br>
          &emsp; - Adicionar modal forms minimizados, (max. 5) na agenda de exames e lista de trabalhadores. (FEITO)<br>
          &emsp; - Criar dropdown nos reports, separando a agenda de exames com lista de trabalhadores. (FEITO)<br>
          &emsp; - Botão floating 'Compilar Report' no canto inferior direito do ecrã. (FEITO) <br>
          &emsp; - Adicionar exame ou trabalhador dependendo do report. (FEITO) <br>
          &emsp; - Delete + Update por ID nos utilizadores (dev only). <br>
          &emsp; - Substituir códigos pela sua nomenclatura nas bases de dados. (FEITO)<br>
          &emsp; - Verificar se nome de utilizador já existe ao criar novo user (dev only). <br>
          &emsp; - Utilizar floating notifs para alertas etc? (LOGIN FEITO) <br>
          &emsp; - Colocar ID para Update + Delete na página users (dev only). <br>
          &emsp; - Nos forms de adição colocar datalist nos inputs disponiveis. 
        </div>
		<br>
        ...
        <div class="row modalWrapper btnrsp">
          ...
          <a href="" class="btn btn-dark btn-rounded btn-sm" name="add" data-toggle="modal" data-target="#modalAdd" href="#"><i class="icon ion-md-add-circle"></i><text class="rsz_hide">&nbsp; Adicionar</text></a>
        ...
        <div class="table-responsive drag" style="overflow-x: hidden;">
          <table id="table" class="table table-striped disable-selection">
            <thead>
              <tr>
                <th style="cursor: pointer;" onclick="sortTable(0);">titulo.Coluna</th>
                <th style="cursor: pointer;" onclick="sortTable(1);">titulo.Coluna</th>
                <th style="cursor: pointer;" onclick="sortTable(2);">titulo.Coluna</th>
                <th style="cursor: pointer;" onclick="sortTable(3);">titulo.Coluna</th>
                <th style="cursor: pointer;" onclick="sortTable(4);">titulo.Coluna</th>
                <th style="cursor: pointer;" onclick="sortTable(5);">titulo.Coluna</th>
                <th style="cursor: pointer;" onclick="sortTable(6);">titulo.Coluna</th>
                <th> </th>
                <th> </th>
            </thead>
            <tbody id="myTable">
              ...
              ?>
                 ...
                 <tr>
                  ...
                  <td><?php echo $CodConsulta ?></td>
                  <td><?php echo $CodConsulta ?></td>
                  <td style="font-size: 17px; padding-right:5px"><a href="update.php?"><ion-icon style="color: #000000; "name="create"></ion-icon></a></td>
                  <td style="font-size: 17px;"><a href="delete.php?" onClick="return confirm('?')" ><ion-icon style="color: #000000; "name="close"></ion-icon></a></td>
                </tr>
