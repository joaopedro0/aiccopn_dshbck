    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="src/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="active"><a href="empresas.php"><i class="ft-briefcase"></i><span class="menu-title" data-i18n="">Empresas</span></a>
          </li>
      ...
      <div class="content-wrapper">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: absolute; right: 1em;">
          <span aria-hidden="true">&times;</span>
              ...
              <br>
              <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Nova Empresa</h4>
              </div>
              <br>
              <div class="modal-body mx-3">
                ...
                <div class="md-form mb-2">
                  ...
                  <input type="text" id="cdgempresa" name="CodEmpresa" class="form-control validate" autocomplete="off">
                </div>

                <div class="md-form mb-2">
                  <label data-error="wrong" data-success="right" for="defaultForm-email">Nome</label>
                  <input type="text" id="nomeempresa" name="Nome" class="form-control validate" autocomplete="off">
                </div>
              ...
              <div class="modal-footer d-flex justify-content-center">
                <button class="btn btn-success"  name="insert_empresa" value="submit" type="submit" >Adicionar</button>
              </div>
        ...
        <div class="modal fade" id="modalEdit" tabindex="0" role="dialog" style="padding-left: 15px !important;">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <br>
              <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Alterar Campo</h4>
              </div>
              <br>
              <div class="modal-body mx-3" >
                ...
                <div class="md-form mb-2">
                    <label data-error="wrong" data-success="right" for="defaultForm-email">C&oacute;digo da Empresa</label>
                  <input type="text" id="cdgempresa" class="form-control validate" autocomplete="off">
                </div>

                <div class="md-form mb-2">
                  <label data-error="wrong" data-success="right" for="defaultForm-email">Nome</label>
                  <input type="text" id="nomeempresa" class="form-control validate" autocomplete="off">
                </div>

                <div class="md-form mb-2">
                  <label data-error="wrong" data-success="right" for="defaultForm-pass">NIF</label>
                  <input type="text" id="nif" class="form-control validate" autocomplete="off">
                </div>

                <div class="md-form mb-2">
                  <label data-error="wrong" data-success="right" for="defaultForm-pass">Morada</label>
                  <input type="text" id="morada" class="form-control validate" autocomplete="off">
                </div>

                <div class="md-form mb-2">
                  <label data-error="wrong" data-success="right" for="defaultForm-pass">Localidade</label>
                  <input type="text" id="local" class="form-control validate" autocomplete="off">
                </div>

              </div>
              <div class="modal-footer d-flex justify-content-center">
                <button class="btn btn-success" onclick="editHtmlTableSelectedRow();">Alterar</button>
              </div>
              <br>
            </div>
          </div>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Empresas</h3>
          </div>
  	...
  	<div class="col-12">
  		<div class="card">
  			<div class="card-header">
  				<h4 class="card-title">Listagem de Empresas</h4>
  			...
  			<div class="card-content collapse show">
  				<div class="card-body">
  						 <p class="card-text"><txt  style="color: #ff4949;"><i class="ficon ft-alert-triangle"  style="color: #ff4949;"></i>&emsp;Ao eliminar uma empresa ir&aacute tamb&eacutem eliminar todos os seus clientes e as suas respetivas consultas&excl;</txt></p>
  				</div>

          <div class="row modalWrapper btnrsp">

            <div class="text-center">
              <a href="" class="btn btn-success btn-rounded btn-sm"  data-toggle="modal" data-target="#modalAdd" href="#"><i class="icon ion-md-add-circle"></i><text class="rsz_hide">&nbsp; Adicionar Empresa</text></a>
            </div>
          ...
          <input type="text" id="myInput" placeholder="Procurar...">
  				...
  				<div class="table-responsive drag " style="overflow-x: hidden;">
  					<table id="table " class="table table-striped disable-selection">
  						<thead>
  							<tr>
  								<th style="cursor: pointer; text-align: center; " onclick="sortTable(0);">C&oacute;d. Empresa</th>
              ...
              <tbody id="myTable">
                ...
                ?>
                   ...
                   <tr>
                    <td style="text-align: center;"><?php echo $CodEmpresa ?></td>
                    <td><?php echo $Nome ?></td>
                    <td><?php echo $Nif ?></td>
                    <td><?php echo $Morada ?></td>
                    <td><?php echo $Localidade ?></td>
                    <td style="font-size: 17px; padding-right:5px"><a href="update.php?Empresa=<?php echo $CodEmpresa ?>"><ion-icon style="color: #00b5e2; "name="create"></ion-icon></a></td>
                    <td style="font-size: 17px;"><a href="delete.php?Empresa=<?php echo $CodEmpresa ?>" onClick="return confirm('Apagar a empresa selecionada?')" ><ion-icon style="color: #db2020;" name="close"></ion-icon></a></td>
                  </tr>
